...
export const exerciseMediaById: Record<string, ExerciseMediaSpec> = {
  ...
  leg_curl: media('Seated_Leg_Curl', youtube('QjNFk4F5dAs', 'How To Use The Leg Curl Machine')),
  ...
  lateral_raise_machine: media('Seated_Side_Lateral_Raise', youtube('z-kOn7flIZg', 'How To Do Lateral Raises')),
  dumbbell_lateral_raise: media('Side_Lateral_Raise', youtube('z-kOn7flIZg', 'How To Do Lateral Raises')),
  cable_lateral_raise: media('Cable_Seated_Lateral_Raise', youtube('Z5FA9aq3L6A', 'How To Do Cable Lateral Raises')),
  ...
  machine_biceps_curl: media('Machine_Bicep_Curl', youtube('MtXdEcW3Eog', 'How To Do A Double Arm Curl')),
  dumbbell_curl: media('Dumbbell_Bicep_Curl', youtube('MtXdEcW3Eog', 'How To Do A Double Arm Curl')),
  cable_triceps_pushdown: media('Triceps_Pushdown', youtube('LXkCrxn3caQ', 'How To Do A Tricep Pushdown')),
  glute_drive: media('Barbell_Hip_Thrust', youtube('aweBS7K71l8', 'How To Do A Barbell Hip Thrust')),
  standing_calf_raise: media('Standing_Calf_Raises', youtube('Zep-wKHWkNM', 'How To Do Calf Raises')),
  machine_crunch: media('Ab_Crunch_Machine', youtube('3RSo2Ehblno', 'How To Use The Ab Crunch Machine')),
};
